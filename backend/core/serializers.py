...
class PersonSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_attending', 'dietary_requirements', 
            'requires_accommodation', 'requires_transfer'
        ]
        extra_kwargs = {
...
class InvitationSerializer(serializers.ModelSerializer):
    ...
    status = serializers.ReadOnlyField() # Calcolato dal modello
        ...
        if guests_data is not None:
            ...
            for g_data in guests_data:
                ...
                if g_id and g_id in existing_guests:
                    ...
                    if 'is_attending' in g_data:
                        guest.is_attending = g_data['is_attending']
                    if 'dietary_requirements' in g_data:
                        guest.dietary_requirements = g_data['dietary_requirements']
                    if 'requires_accommodation' in g_data:
                        guest.requires_accommodation = g_data['requires_accommodation']
                    if 'requires_transfer' in g_data:
                        guest.requires_transfer = g_data['requires_transfer']
...
class InvitationListSerializer(serializers.ModelSerializer):
    ...
    status = serializers.ReadOnlyField() # Calcolato
