...
describe('LetterContent Coverage', () => {
  ...
  describe('Replay System', () => {
    ...
    it('handles REPLAY_ACTION: card_expand and card_collapse', () => {
      ...
      expect(screen.getByText('cards.evento.title')).toBeInTheDocument();
    ...
    it('handles REPLAY_ACTION: travel and accommodation', () => {
        ...
        expect(screen.getByText('rsvp.messages.already_confirmed')).toBeInTheDocument();
    });
  });
  ...
  describe('Static Cards', () => {
    it('renders all static cards', () => {
        ...
        cards.forEach(card => {
            fireEvent.click(screen.getByText(`cards.${card}.title`));
    ...
    it('renders alloggio not offered', () => {
        ...
        fireEvent.click(screen.getByText(`cards.alloggio.title`));
  ...
  describe('Wizard Edge Cases', () => {
      it('validates contact step with empty phone', () => {
          ...
          // Should see error
          expect(screen.getByText('rsvp.validation.phone_missing')).toBeInTheDocument();
      });
  ...
  describe('WhatsApp Link', () => {
      it('generates correct link', () => {
        render(<LetterContent data={mockData} />);
        fireEvent.click(screen.getByText('cards.cosaltro.title'));
