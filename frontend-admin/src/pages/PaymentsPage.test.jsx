// frontend-admin/src/pages/PaymentsPage.test.jsx
...
// Stub heavy sub-components to isolate PaymentsPage logic
...
const renderPage = () => render(<PaymentsPage />);
...
describe('PaymentsPage', () => {
  ...
  it('shows skeleton loaders while fetching', () => {
    ...
    renderPage();
    // 3 skeleton divs with animate-pulse
  ...
  it('increments refreshKey and re-fetches on refresh button click', async () => {
    ...
    const refreshBtn = screen.getByRole('button', { name: /common.loading/i });
