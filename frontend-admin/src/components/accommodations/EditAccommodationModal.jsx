        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">{t('admin.accommodations.edit_modal.title')}</h2>
                        <p className="text-sm text-gray-500">{t('admin.accommodations.edit_modal.step_of', { step, total: 2 })}</p>
                    </div>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    {step === 1 ? (
                        ...
                        <div className="space-y-4">
                                ...
                                <div key={idx} className="flex gap-3 items-end bg-gray-50 p-3 rounded-lg border border-gray-100">
                                    <div className="flex-grow">
                                        ...
                                        <input 
                                            ...
                                            placeholder={t('admin.accommodations.edit_modal.step2.room_placeholder')}
                                        />
                                    </div>
                                    <div className="w-20">
                            ...
                            >
                                <Plus size={20} />
                                {t('admin.accommodations.edit_modal.step2.add_room')}
                            </button>
                        </div>
                    )}
                </div>
                ...
                <div className="px-6 py-4 border-t border-gray-100 flex justify-between bg-gray-50">
                    {step === 1 ? (
                        <div className="ml-auto">
                            ...
                            >
                                {t('admin.accommodations.edit_modal.buttons.next')} <ArrowRight size={18} />
                            </button>
                        </div>
                    ) : (
                        <>
                            ...
                            >
                                <Save size={18} /> {t('admin.accommodations.edit_modal.buttons.save')}
                            </button>
                        </>
                    )}
                </div>
